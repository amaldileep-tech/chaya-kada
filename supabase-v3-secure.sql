...
begin
  ...
  -- Use an explicit UPDATE + INSERT instead of ON CONFLICT here because the
  -- function RETURNS TABLE(room_id, ...) and an unqualified room_id in
  -- ON CONFLICT is ambiguous to PL/pgSQL.
